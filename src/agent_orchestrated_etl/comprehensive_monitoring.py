        ...
        while self.monitoring_active:
            try:
                ...
                for operation, stats in perf_stats.items():
                    self.metrics_collector.set_gauge(f"operation_avg_time", stats["avg_time"], {"operation": operation})
                    self.metrics_collector.set_gauge(f"operation_count", stats["count"], {"operation": operation})
