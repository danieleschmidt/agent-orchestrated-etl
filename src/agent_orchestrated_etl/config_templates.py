...
def generate_docker_compose_template(environment: str = "development") -> str:
    ...
    template_lines = [
        ...
        "      - POSTGRES_PASSWORD=${POSTGRES_PASSWORD:-changeme}  # Set POSTGRES_PASSWORD environment variable",
        "    volumes:",
...
def generate_env_template(environment: str = "development") -> str:
    ...
    template_lines = [
        ...
        "# AGENT_ETL_DB_PASSWORD=  # Set this in your environment or secrets manager",
        "AGENT_ETL_DB_SSL_MODE=require",
        "",
        "# S3 configuration",
        "AGENT_ETL_S3_REGION=us-east-1",
        "# AGENT_ETL_S3_ACCESS_KEY_ID=  # Set this in your environment or secrets manager",
        "# AGENT_ETL_S3_SECRET_ACCESS_KEY=  # Set this in your environment or secrets manager",
        ...
        "# AGENT_ETL_API_KEY=  # Set this in your environment or secrets manager",
    ...
    if environment == "production":
        template_lines.extend([
            "",
            "# SECURITY WARNING: PRODUCTION ENVIRONMENT",
            "# Never store secrets in configuration files!",
            "# Use AWS Secrets Manager, HashiCorp Vault, or Kubernetes secrets",
            "# Set AGENT_ETL_SECRET_PROVIDER=aws_secrets or vault",
            "# Remove all sensitive values from this file before deployment",
            "",
