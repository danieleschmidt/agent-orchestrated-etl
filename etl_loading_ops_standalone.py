"""Standalone version of ETL Loading Operations for testing.

This is a test-friendly version that doesn't rely on relative imports.
"""
...
class AgentException(Exception):
    """Mock agent exception for testing."""
    pass

class DataProcessingException(Exception):
    """Mock data processing exception for testing."""
    pass

class LogContext:
    """Mock log context for testing."""
